...
@section('content')
<form method="post" action="/keranjang/bayar/" enctype="multipart/form-data">
    @csrf
    <div class="row">
        <div class="col-9">
            <div class="card">
                ...
                <div class="row g-0">
                    ...
                    <div class="col-md-9">
                        <div class="card-body">
                            ...
                            $diskon = App\Models\discount::where('product_id', '=', $keranjangs->product->id)->where('start', '<=', $tanggal)->where('end', '>=', $tanggal)->get();
                                ...
                                <div class="text-end">
                                    <div class="form-inline">
                                        ...
                                        <h6 class="card-subtitle mb-2 mt-2 text-muted">Rp.</h6>
                                        <h6 class="card-subtitle mb-2 mt-2 text-muted">{{$h = $harga * $keranjangs->qty}}</h6>
                                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-7">
                            <div class="form-inline mb-3">
                                ...
                                <h6 class="card-subtitle text-muted">{{$total_harga}}</h6>
                            </div>
                            <div class="form-inline">
                                <h6 class="card-subtitle text-muted">Rp.</h6>
                        ...
                        <div class="col-7">
                            <div class="form-inline">
                                ...
                                <h6 class="card-subtitle mb-2 text-muted">{{$j = $total_harga + $shipping_cost }}</h6>
                            </div>
                        </div>
                    </div>
