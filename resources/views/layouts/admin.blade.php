...
<body class="app header-fixed sidebar-fixed aside-menu-fixed pace-done sidebar-lg-show">
    <header class="app-header navbar">
        ...
        <a class="navbar-brand" href="/">
            <span class="navbar-brand-full">Furniture Shop</span>
            <span class="navbar-brand-minimized">FS</span>
        </a>
       ...
       <li class="nav-item dropdown no-arrow mx-1 ">
                            <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button"
                                ...
                                <!-- Counter - Alerts -->
                                @php $admin_unRead = App\Models\admin_notification::where('notifiable_id',1)->where('read_at', NULL)->orderBy('created_at','desc')->count(); @endphp
                            ...
                            <!-- alert data pesan ------------------------------------------------------------- -->
                                @php $admin_notifikasi = App\Models\admin_notification::where('notifiable_id',1)->where('read_at', NULL)->orderBy('created_at','desc')->paginate(5); @endphp
